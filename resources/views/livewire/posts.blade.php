<div class="content mx-auto mt-2">
    <x-jet-banner />
...
<div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
  <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
      <table class="w-full divide-y divide-gray-200 ">
        ...
        <x-jet-button wire:click="deletePost({{$post->id}})" class="bg-red-500" >
          Delete
        </x-jet-button>
 ...
 <x-jet-dialog-modal wire:model="showModalForm">
     ...
     <x-slot name="content"><div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
